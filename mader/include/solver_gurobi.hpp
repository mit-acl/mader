...
private:
  ...
  std::vector<Eigen::Vector3d> n_;  // Each n_var_[i] has 3 elements (nx,ny,nz)
  std::vector<double> d_;           // d_var_[i] has 1 element

  // std::vector<std::vector<GRBVar>> n_var_;  // Each n_var_[i] has 3 elements (nx,ny,nz)
  // std::vector<GRBVar> d_var_;               // d_var_[i] has 1 element
