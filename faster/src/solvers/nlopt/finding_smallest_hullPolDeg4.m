...
pol_x=[0 0.2 0.3 2 1]';%[a b c d]
pol_y=[0 -0.3 +3 -5 6]';%[a b c d]
pol_z=[0 1 -0.1 -1 -4]';%[a b c d]
...
for i=1:4
    ...
    constraints=[constraints, (Wi(3,3)>=0):'Wi33>=0'];
...
constraints=[constraints (A*ones(4,1)==[0 0 0 0 1]'):'A*1==[0 0 0 0 1]'];%Sum \lambda_i(t)=1
...
settings=sdpsettings('usex0',1,'savesolveroutput',1,'savesolverinput',1,'solver','fmincon','showprogress',1,'verbose',2,'debug',1,'fmincon.maxfunevals',3e100,'fmincon.MaxIter', 1e100);
