...
constraints=[];
constraints=[constraints A'*ones(4,1)==zeros(4,1)];
...
constraints=[constraints sum_Wi==[0 0; 0 1]];
constraints=[constraints sum_Vi==[0 0; 0 1]];
...
obj=abs(det(A)); %Should I put abs() here?
