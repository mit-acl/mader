...
In order to access the NUCs of all the agents, you need to establish an ip route in base station that defines how to get to the NUCs (which is through their VOXLs' ethernet port as they are connected).
